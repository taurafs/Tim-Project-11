(function ($) {
  ...
  if ($("#areaChart").length) {
    ...
    var graphGradient1 = document.getElementById('areaChart').getContext("2d");
    var graphGradient2 = document.getElementById('areaChart').getContext("2d");
    var graphGradient3 = document.getElementById('areaChart').getContext("2d");
  ...
  if ($("#traffic-chart").length) {
    ...
    new Chart(ctx, {
      type: 'doughnut',
      data: {
        labels: ['Money Transfer', 'Rent', 'Food And Groceries','Other'],
        datasets: [{
          data: [30, 30, 40],
